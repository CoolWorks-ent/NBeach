Shader "Toon/Lit Swaying Interactive_Test" {
    Properties {
    ...
    SubShader {
        Tags { "IgnoreProjector" = "True" "RenderType" = "TreeLeaf" "DisableBatching" = "True" }// disable batching lets us keep object space
		LOD 200
...
void surf (Input IN, inout SurfaceOutput o) {
	...
	o.texcoord = TRANSFORM_TEX(IN.uv_MainTex, _MainTex);
